...
function initUnboxFrame()
	...
	closeBut.Paint = function(s , w , h)
		...
		draw.SimpleText("关闭","ub2_2",w/2 , h/2 , Color(255,255,255,255) , 1 , 1)
	...
	shopBut.Paint = function(s , w , h)
		...
		draw.SimpleText("商店","ub2_2",w/2 , h/2 , Color(255,255,255,255) , 1 , 1)
	...
	inventoryBut.Paint = function(s , w , h)
		...
		draw.SimpleText("库存","ub2_2",w/2 , h/2 , Color(255,255,255,255) , 1 , 1)
	...
	ubCratePanel.Paint = function(s , w , h)
		...
		if LocalPlayer().ubinv == nil or table.Count(LocalPlayer().ubinv) == 0 then
			...
			draw.SimpleText("当前库存为空，你没有任何物品! :(","ub2_5",800/2 , (600/2) - 50,Color(255,255,255,255) , 1 , 1)
			draw.SimpleText("打开商店购买吧","ub2_3",800/2 , (600/2),Color(255,255,255,255) , 1 , 1)
...
function createModelModule(k , v , x ,y)
	...
	mod:SetPos(0,0)
	mod:SetSize(180,180)
	print("[ASDASDASDASDA]ASD[ASDASDASD]")
	print(v.model)
...
function initSpinMenu(itemID)
	...
	for k , v in pairs(tape) do
		...
		if k == 87 or BUC2.ITEMS[v].itemType == "Weapon" or BUC2.ITEMS[v].itemType == "PSItem" or BUC2.ITEMS[v].itemType == "PS2Item" or BUC2.ITEMS[v].itemType == "Entity" then
			
			tmod = vgui.Create("DModelPanel", t)
			tmod:SetSize(100,100)
			tmod:SetPos(0,0)
			if BUC2.ITEMS[v].itemType == "Weapon" or BUC2.ITEMS[v].itemType == "PSItem" or BUC2.ITEMS[v].itemType == "PS2Item" or BUC2.ITEMS[v].itemType == "Entity" then
...
net.Receive("ub_inventory_update" , function()
	...
	for k ,v in pairs(e) do 
		table.insert(i , BUC2.IDToItem[v])  
	end  
	PrintTable(i)
	LocalPlayer().ubinv = i
	ub_refreshInventory()

	print("[UB INVENTORY LOADED]")
	PrintTable(e)
