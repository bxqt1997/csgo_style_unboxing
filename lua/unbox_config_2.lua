...
BUC2.CanTradePermaWeapons = false --If this is true then user can trade permanent items. This can be used to abuse buy equiping then trading. (False it recomended)
--Edit under here.
BUC2.BuyItemsWithPoints = true --If this is false then it WILL use darkrp cash.
...
bu_addCrate(1, "武器箱" , "开箱得武器." , Color(128, 128, 128, 255) , "武器钥匙" , true , true ,  100)
bu_addCrate(2, "Money Crate" , "Contains DarkRP cash" , Color(249,200,7,255) , "Money Key" , true , true ,  100)
bu_addCrate(3, "Points Crate" , "开箱得积分商店积分" , Color(0,255,25,255) , "Points Key" , true , true ,  100)
...
bu_addKey(5,"武器钥匙" , "用来打开武器箱" , Color(249,200,7,255)  , false, true , 1000)
...
bu_addWeapon(9,"Pistol", "A Pistol", "weapon_pistol" , "models/weapons/w_pistol.mdl", Color(100,100,255) , "武器箱" , 1000 , false)
bu_addWeapon(10,"[P] Pistol", "A Permanent Pistol", "weapon_pistol" , "models/weapons/w_pistol.mdl", Color(100,100,255) , "武器箱" , 100 , true)
bu_addWeapon(11,"Shotgun", "A Shotgun", "weapon_shotgun" , "models/weapons/w_shotgun.mdl", Color(255,0,200) , "武器箱" , 300 , false)
bu_addWeapon(12,"[P] Shotgun", "A Permanent Shotgun", "weapon_shotgun" , "models/weapons/w_shotgun.mdl", Color(255,0,200) , "武器箱" , 30 , true)
bu_addWeapon(13,"RPG", "A RPG", "weapon_rpg" , "models/weapons/w_rocket_launcher.mdl", Color(255,15,15) , "武器箱" , 50 , false)
bu_addWeapon(14,"[P] RPG", "A Permanent RPG", "weapon_rpg" , "models/weapons/w_rocket_launcher.mdl", Color(255,15,15) , "武器箱" , 5 , true)
